...
In symmetric Boolean functions, we don't know whether a specific
input is 0 or 1; we only know the number of 1s in the input.
A similar situation arises in anonymous symmetric pure strategy
graphical games where each player's strategy is one of 0 and 1.
...
problem relates to the problem of Nash equilibria in such games and
