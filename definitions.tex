...
\smallskip
\noindent
\textbf{Additional definitions regarding SyDSs:}~
...
\smallskip
\noindent
\textbf{Graph theoretic definitions:}~
...
\smallskip
\noindent
\textbf{Boolean function definitions :}~
\iffalse
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fi
Most of the definitions given here can be found in \cite{Crama-Hammer-2011}. 
