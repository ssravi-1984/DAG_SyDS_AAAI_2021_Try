...
of local functions, one per node.
...
to consider whether a given system may reach certain
...
the SyDS.
Thus, there has been a considerable amount of research whose goal is
...
It was shown that these problems are \cpsp-complete for general
directed graphs.
It was also shown that the Convergence problem can be solved
...
even when restricted to dags with  three levels 
